...
//  const instituteName = localStorage.getItem("instituteName");
  ...
  useEffect(() => {
    ...
    if (userDetails) {
      fetch(`http://localhost:9090/prava/user/${userId}`)
                                ...
                                <div className="row">
                                  <div class="row">
                                    <div className=" col-6 mb-3">
                                      Experience :{" "}
                                      <p>{userProfile.years} Yrs</p>
                                    </div>

                                    <div className=" col-6 mb-3">
                                      Interested In :
                                      <p>{userProfile.typeofmode}</p>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <div className=" col-6 mb-3">
                                      Salary :{" "}
                                      <p>{userProfile.currentSalary1}</p>
                                    </div>

                                    <div className=" col-6 mb-3">
                                      state : <p>{userProfile.state}</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="container-fluid d-flex mt-4">
                                <div className="row">
                                  <div class="row">
                                    <div className=" col-6 mb-3">
                                      Role :{" "}
                                      <p>{userProfile.selectedOption} </p>
                                    </div>

                                    <div className=" col-6 mb-3">
                                      Interested In :{" "}
                                      <p>{userProfile.proficiency}</p>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <div className=" col-6 mb-3">
                            ...
                            {showNestedCard3 && (
                              <div className="container-fluid d-flex mt-4">
                                <div class="row">
                                  ...
                                  <div className=" col-6 mb-3">
                                    Statement : <p>{userProfile.statement}</p>
                                  </div>
                                </div>
                              </div>
                            )}
